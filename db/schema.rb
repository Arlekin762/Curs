...
ActiveRecord::Schema.define(version: 20170520135134) do
  ...
  add_index "showrooms", ["collection_id"], name: "index_showrooms_on_collection_id", using: :btree
  ...
  add_foreign_key "showrooms", "collections"
end
