class RoleUsersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @role_user.save
        format.html { redirect_to @role_user, notice: 'Пользователь роли успешно создан.' }
  ...
  def update
    respond_to do |format|
      if @role_user.update(role_user_params)
        format.html { redirect_to @role_user, notice: 'Пользователь роли успешно обновлен.' }
  ...
  def destroy
    @role_user.destroy
    respond_to do |format|
      format.html { redirect_to role_users_url, notice: 'Пользователь роли успешно уничтожен
.' }
