class ShowroomsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @showroom.save
        format.html { redirect_to @showroom, notice: 'Выставочный зал был успешно создан.' }
  ...
  def update
    respond_to do |format|
      if @showroom.update(showroom_params)
        format.html { redirect_to @showroom, notice: 'Выставочный зал успешно обновлен
.' }
  ...
  def destroy
    @showroom.destroy
    respond_to do |format|
      format.html { redirect_to showrooms_url, notice: 'Выставочный зал успешно уничтожен.' }
  ...
  private
    ...
    def showroom_params
      params.require(:showroom).permit(:name, :collection_id)
    end
end
